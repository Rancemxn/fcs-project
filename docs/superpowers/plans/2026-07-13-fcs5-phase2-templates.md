...
- [x] **Step 1: Write failing AST/API tests**
...
- [x] **Step 2: Run the focused test and verify the expected compile failure**
...
- [x] **Step 3: Implement the minimal AST types**
...
- [x] **Step 4: Run focused tests and existing Phase 2 tests**

Run `cargo nextest run -p fcs-core --test fcs5_phase2`. All tests should pass.

- [x] **Step 5: Commit the AST boundary**
...
- [x] **Step 3: Implement block parsing**
...
- [x] **Step 4: Run parser and regression tests**
...
- [x] **Step 1: Write failing expansion and validation tests**
...
- [x] **Step 2: Run tests and verify they fail for the missing expansion path**
...
- [x] **Step 1: Write failing conditional and fixture tests**
...
- [x] **Step 3: Implement the minimal conditional expansion**
...
- [x] **Step 4: Run full required validation**
...
- [x] **Step 5: Update status documentation and commit**
