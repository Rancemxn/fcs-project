...
| `tempoMapBlock`, `tempoPoint`, `bpmLiteral` | `A::source_parser_retains_tempo_maps_for_later_validation`, `G` | `D::rejects_removed_mixed_beat_literal`, `L` for sign/order/profile validity |
