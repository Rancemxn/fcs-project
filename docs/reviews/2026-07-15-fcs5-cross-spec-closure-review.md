...
确认门已由 2026-07-16 治理修订取消，当前客观阶段门以 `docs/specification-governance.md` 为准。
...
| `conformance/fcbc/` tree（11 files） | `1cedf8f6830a2d36a1839c78c9c53c5658bd01d88f1ef44968b35836185ef9c3` |
| `conformance/` tree（92 files） | `6b40d46536ec1cc7c5b6d4642eae17c8547e8696fca9f95d1f981899dbde4090` |
