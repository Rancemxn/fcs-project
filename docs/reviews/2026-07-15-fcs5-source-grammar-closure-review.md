...
`docs/specifications/governance.md` 的未发布候选例外，撤回 2026-07-14 对 FCS Core 5.0.0 和
...
conformance tree (51 files; paths relative to docs/conformance/ with / separators; ordinal path order;
...
状态和 I1 启动条件以 `docs/specifications/governance.md` 与 `docs/plans/fcs5-roadmap.md` 为准。
