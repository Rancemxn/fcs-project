...
pub struct RpeMeta {
    #[serde(rename = "RPEVersion", default = "default_rpe_version")]
    pub rpe_version: i32,
    #[serde(default)]
    pub name: String,
    #[serde(default)]
...
pub struct RpeJudgeLine {
    ...
    #[serde(rename = "zOrder")]
    pub z_order: i32,
    #[serde(deserialize_with = "deser_layers")]
...
pub struct RpeEventLayer {
    ...
    pub move_x_events: Vec<RpeCommonEvent>,
